...
$conexion = mysqli_connect('localhost', 'root', '', 'db_ecommerceeee');
    ...
    Mi Cuenta </a>
                                            ...
                                            <div class="user-area dropdown float-right">
                                                ...
                                                <div class="user-menu dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="nav-link" href="#"><i class="fa fa- user"></i>Panell <span class="count">13</span></a>
                                                    </li>
                                                    <li>
                                                        <a class="nav-link" href="#"><i class="fa fa- user"></i>Checar No.Orden <span class="count">13</span></a>
                                                    </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <nav class="header__menu">
                            <ul>
                                <li class="active">
                                    <a href="./indexxx-copiaa.php">Inicio</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ul class="header__menu__dropdown">
                                        <li>
                                            <a href="shop-details1.php">Detalles</a>
                                        </li>
                                        <li>
                                            <a href="./shoping-cart.html">Carrito</a>
                                        </li>
                                        <li>
                                            <a href="./checkout-copia.php">Pago</a>
                                        </li>
                                        <li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
                        <div class="footer__widget">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="./PoliticasYprivacidad.html">Politicas De privacidad</a>
                                </li>
                                <li>
                                    <a href="./TerminosYcondiciones.html">Terminos y Condiciones</a>
                                </li>
                                <li>
                                    <a href="./TerminosdeEnvio.html">Politicas de Envio </a>
                                </li>
                            </ul>
                        </div>
                    </div>
