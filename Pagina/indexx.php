                            ...
                            <div class="header__top__right">
                                ...
                                <li>
                                    <div class="user-area dropdown float-right">
                                        ...
                                        <a href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Mi cuenta</a>
                                        <div class="user-menu dropdown-menu">
                                            <a class="nav-link" href="indexx.php?modulo=editarPerfil&id=<?php echo $_SESSION['idCliente']; ?>"><i class="fa fa- user"></i>Mi perfil</a>
                                            <a class="nav-link" href="#"><i class="fa fa- user"></i>Notificaciones <span class="count">13</span></a>
                                            <a class="nav-link" href="indexx.php?modulo=&sesion=cerrar" title="Cerrar sesion">Logout</a>
                                        </div>
                                    </div>
                                    <div class="header__top__right__auth">
